                  ...
                  <div class="row">
                    <div class="col-lg-4 col-md-6">
                      <div class="property-boxarea">
                        ...
                        <div class="content-area">
                          <a href="property-details-v1.html">Apartment Complex</a>
                          <div class="space18"></div>
                          <p>Los Angeles City, CA, USA</p>
                          <div class="space24"></div>
                          <ul>
                    ...
                    <div class="col-lg-4 col-md-6">
                      <div class="property-boxarea">
                        ...
                        <div class="content-area">
                          <a href="property-details-v1.html">Diamond Apartment</a>
                          <div class="space18"></div>
                          <p>Los Angeles City, CA, USA</p>
                          <div class="space24"></div>
                          <ul>
                    ...
                    <div class="col-lg-4 col-md-6">
                      ...
                      <div class="property-boxarea">
                        ...
                        <div class="content-area">
                          <a href="property-details-v1.html">Suburb Home for Rent </a>
                          <div class="space18"></div>
                          <p>Los Angeles City, CA, USA</p>
                          <div class="space24"></div>
                          <ul>
        ...
        <div class="col-lg-4">
          <div class="box-slider">
            <div class="item-featured-boxarea">
              ...
              <div class="space28"></div>
              <div class="btn-area1">
                <a href="sidebar-grid.html" class="theme-btn1">Schedule Visit <span class="arrow1"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" fill="currentColor">
                      <path d="M12 13H4V11H12V4L20 12L12 20V13Z"></path>
                    </svg></span><span class="arrow2"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" fill="currentColor">
                      <path d="M12 13H4V11H12V4L20 12L12 20V13Z"></path>
                    </svg></span></a>
        ...
        <div class="col-lg-3 col-md-6">
          <div class="footer-content">
            ...
            <ul>
              ...
              <li><a href="sidebar-grid.html">Listing</a></li>
              <li><a href="property-halfmap-grid.html">Properties</a></li>
